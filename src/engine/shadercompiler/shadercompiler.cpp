...
int main(int argc, char* argv[]) {
    try {
        ...
        app.add_option("--files,files", files, "Source files to open");
        std::vector<std::string> compiledShaders;
        app.add_option("--shaders", compiledShaders,
                       "Shaders to compile (everything is compiled if parameter is not given)");
        ...
        std::string binFile = "";
        app.add_option("-o,--output", binFile, "Output shader binary file");
        // std::string root = "";
