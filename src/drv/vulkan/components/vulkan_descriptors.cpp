...
//     VkResult result = vkCreateDescriptorSetLayout(drv::resolve_ptr<VkDevice>(device), &layoutInfo,
//                                                   nullptr, &layout);
//     drv::drv_assert(result == VK_SUCCESS, "Could not create descriptor set layout");
//     return drv::store_ptr<drv::DescriptorSetLayoutPtr>(layout);
// }

// bool DrvVulkan::destroy_descriptor_set_layout(drv::LogicalDevicePtr device,
//                                               drv::DescriptorSetLayoutPtr layout) {
//     vkDestroyDescriptorSetLayout(drv::resolve_ptr<VkDevice>(device),
//                                  drv::resolve_ptr<VkDescriptorSetLayout>(layout), nullptr);
//     return true;
// }
...
//       drv::resolve_ptr<VkDescriptorPool>(allocateInfo->descriptorPool);
...
//     VkResult result = vkAllocateDescriptorSets(drv::resolve_ptr<VkDevice>(device), &vkAllocateInfo,
