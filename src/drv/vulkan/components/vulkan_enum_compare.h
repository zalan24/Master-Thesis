...
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_1, VK_SAMPLE_COUNT_1_BIT);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_2, VK_SAMPLE_COUNT_2_BIT);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_4, VK_SAMPLE_COUNT_4_BIT);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_8, VK_SAMPLE_COUNT_8_BIT);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_16, VK_SAMPLE_COUNT_16_BIT);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_32, VK_SAMPLE_COUNT_32_BIT);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_64, VK_SAMPLE_COUNT_64_BIT);

COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::POINT_LIST, VK_PRIMITIVE_TOPOLOGY_POINT_LIST);
COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::LINE_LIST, VK_PRIMITIVE_TOPOLOGY_LINE_LIST);
COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::LINE_STRIP, VK_PRIMITIVE_TOPOLOGY_LINE_STRIP);
COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::TRIANGLE_LIST, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST);
COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::TRIANGLE_STRIP,
              VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP);
COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::TRIANGLE_FAN, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_FAN);
// TODO tessellation or geometry shader
// COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::LINE_LIST_WITH_ADJACENCY, VK_PRIMITIVE_TOPOLOGY_LINE_LIST_WITH_ADJACENCY);
// COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::LINE_STRIP_WITH_ADJACENCY, VK_PRIMITIVE_TOPOLOGY_LINE_STRIP_WITH_ADJACENCY);
// COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::TRIANGLE_LIST_WITH_ADJACENCY, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST_WITH_ADJACENCY);
// COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::TRIANGLE_STRIP_WITH_ADJACENCY, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP_WITH_ADJACENCY);
// COMPARE_ENUMS(uint32_t, drv::PrimitiveTopology::PATCH_LIST, VK_PRIMITIVE_TOPOLOGY_PATCH_LIST);

COMPARE_ENUMS(uint32_t, drv::PolygonMode::FILL, VK_POLYGON_MODE_FILL);
COMPARE_ENUMS(uint32_t, drv::PolygonMode::LINE, VK_POLYGON_MODE_LINE);
COMPARE_ENUMS(uint32_t, drv::PolygonMode::POINT, VK_POLYGON_MODE_POINT);

COMPARE_ENUMS(uint32_t, drv::CullMode::NONE, VK_CULL_MODE_NONE);
COMPARE_ENUMS(uint32_t, drv::CullMode::FRONT_BIT, VK_CULL_MODE_FRONT_BIT);
COMPARE_ENUMS(uint32_t, drv::CullMode::BACK_BIT, VK_CULL_MODE_BACK_BIT);
COMPARE_ENUMS(uint32_t, drv::CullMode::FRONT_AND_BACK, VK_CULL_MODE_FRONT_AND_BACK);

COMPARE_ENUMS(uint32_t, drv::FrontFace::COUNTER_CLOCKWISE, VK_FRONT_FACE_COUNTER_CLOCKWISE);
COMPARE_ENUMS(uint32_t, drv::FrontFace::CLOCKWISE, VK_FRONT_FACE_CLOCKWISE);

COMPARE_ENUMS(uint32_t, drv::CompareOp::NEVER, VK_COMPARE_OP_NEVER);
COMPARE_ENUMS(uint32_t, drv::CompareOp::LESS, VK_COMPARE_OP_LESS);
COMPARE_ENUMS(uint32_t, drv::CompareOp::EQUAL, VK_COMPARE_OP_EQUAL);
COMPARE_ENUMS(uint32_t, drv::CompareOp::LESS_OR_EQUAL, VK_COMPARE_OP_LESS_OR_EQUAL);
COMPARE_ENUMS(uint32_t, drv::CompareOp::GREATER, VK_COMPARE_OP_GREATER);
COMPARE_ENUMS(uint32_t, drv::CompareOp::NOT_EQUAL, VK_COMPARE_OP_NOT_EQUAL);
COMPARE_ENUMS(uint32_t, drv::CompareOp::GREATER_OR_EQUAL, VK_COMPARE_OP_GREATER_OR_EQUAL);
COMPARE_ENUMS(uint32_t, drv::CompareOp::ALWAYS, VK_COMPARE_OP_ALWAYS);

COMPARE_ENUMS(uint32_t, drv::ImageFilter::NEAREST, VK_FILTER_NEAREST);
COMPARE_ENUMS(uint32_t, drv::ImageFilter::LINEAR, VK_FILTER_LINEAR);
