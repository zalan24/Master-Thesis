...
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_1, VK_SAMPLE_COUNT_1);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_2, VK_SAMPLE_COUNT_2);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_4, VK_SAMPLE_COUNT_4);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_8, VK_SAMPLE_COUNT_8);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_16, VK_SAMPLE_COUNT_16);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_32, VK_SAMPLE_COUNT_32);
COMPARE_ENUMS(uint32_t, drv::SampleCount::SAMPLE_COUNT_64, VK_SAMPLE_COUNT_64);
